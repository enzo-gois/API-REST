...
beforeAll(async () => {
  ...
  const users = await app.db('users').insert([
    {name: 'User #1', mail: 'user@mail.com', passwd: '$2a$10$Rye3R.3XZcCcYwZxvAg0e.RJMMQTP9l77AejvonnjPpRegvPZZJFq'},
    {name: 'User #2', mail: 'user2@mail.com', passwd: '$2a$10$Rye3R.3XZcCcYwZxvAg0e.RJMMQTP9l77AejvonnjPpRegvPZZJFq'},
  ], '*');
  [user,user2] = users;
  delete user.passwd;
